...
gulp.task('sass_production', function () {
    gulp.src('app/sass/**/*')
        ...
        .pipe(gulp.dest(homepage_folder+'css/'));
});
...
gulp.task('production_html', function() {
    gulp.src(['app/**/*.html' , '!app/index.html'])
        .pipe(gulp.dest(homepage_folder))
});
...
gulp.task('production_libs', function() {
    gulp.src(bc+'jquery/dist/jquery.js').pipe(gulp.dest(homepage_folder+'libs/jquery/'));

    gulp.src(bc+'font-awesome/css/*.*').pipe(gulp.dest(homepage_folder+'libs/font-awesome/css'));

    gulp.src(bc+'font-awesome/fonts/*').pipe(gulp.dest(homepage_folder+'libs/font-awesome/fonts'));

    gulp.src(bc+'bootstrap/dist/**/*.*').pipe(gulp.dest(homepage_folder+'libs/bootstrap/'));

    gulp.src(bc+'masonry/dist/*.*').pipe(gulp.dest(homepage_folder+'libs/masonry/'));

    gulp.src(bc+'imagesloaded/*.js').pipe(gulp.dest(homepage_folder+'libs/imagesloaded/'));
...
//            bc+'angularfire/dist/angularfire.js',
        ...
        .pipe(gulp.dest(homepage_folder+'libs/angular/'));
});
